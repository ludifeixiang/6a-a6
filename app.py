...
# 环境变量
UUID = os.environ.get('UUID', 'ec9526a5-aa5e-49a6-868c-28b7f74c5426')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'tianyoude.apps.apply.build')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
